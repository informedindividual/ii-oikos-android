...
public final class Util {
	...
	/**
	 * Connect to an HTTP URL and return the response as a string. Note that the HTTP method override is used on non-GET requests.
	 ...
	 */
	public static String openUrl(String url, final String method, final Bundle params) throws MalformedURLException, IOException {
	...
	/**
	 * Parse a server response into a JSON Object. This is a basic implementation using org.json.JSONObject representation. More
	 * sophisticated applications may wish to do their own parsing. The parsed JSON is checked for a variety of error fields and a
	 * FacebookException is thrown if an error condition is set, populated with the error message and error type or code if
	 * available.
	 * 
